                            ...
                            <tbody>
                                ...
                                foreach ($datadonasi as $donasi) { ?>
                                    <tr>
                                        ...
                                        <a class="btn btn-warning rounded-pill" href="edit.php?id=<?= $donasi['id'] ?>">
                                            ...
                                            <a class="btn btn-danger rounded-pill" onclick="return confirm('Anda yakin ingin menghapus data ini?')" ; href="crud.php?hapus=<?= $donasi['id'] ?>">
